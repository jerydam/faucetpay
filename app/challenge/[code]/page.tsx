      ...
      .then(d => {
        ...
        const playerEntries = Object.entries(d.challenge.players ?? {}).map(
            ([wallet, data]: [string, any]) => ({
              ...
              avatarUrl: data.avatar_url ?? "",   // ← was missing avatar_url mapping
            })
          );
            ...
            {!myTxVerified && (
              <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900">
                ...
                <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                  Your wallet will prompt you to approve <strong>{parseInt(displayStake + 0.5)} {challenge?.token} as the 0.5 {challenge?.token} is for escrow fee</strong> on Celo.
